...
async function setupRLS() {
  ...
  await runQuery(`drop policy if exists "roles_select_authenticated" on public.roles;`)
  await runQuery(`
...
async function validate() {
  ...
  const roles = await runQuery(`select code, name from public.roles order by code;`)
  console.log('📋 Papéis:')
