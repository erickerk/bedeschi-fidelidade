...
async function main() {
  ...
  if (!tablesExist) {
    ...
    console.log('1. Acesse: https://supabase.com/dashboard/project/lvqcualqeevdenghexjm/sql/new');
    console.log('2. Cole o conteúdo de: supabase/migrations/006_create_fidelity_tables.sql');
