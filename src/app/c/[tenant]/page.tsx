...
export default function ClientAccessPage() {
  ...
  return (
    ...
    >
      {/* Background */}
      <div
        className={`absolute inset-0 ${isDark ? "bg-gradient-to-t from-amber-900/10 via-transparent to-transparent" : ""}`}
      />
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center px-4">
        ...
        {step === "login" && (
          <div className="w-full max-w-md text-center">
            ...
            <div className="mb-8">
              ...
              <div
                className={`h-px w-32 mx-auto mb-3 ${isDark ? "bg-gradient-to-r from-transparent via-amber-500/50 to-transparent" : "bg-gradient-to-r from-transparent via-amber-400/50 to-transparent"}`}
              />
              <p
        ...
        {step === "pin" && (
          <div className="w-full max-w-xs text-center">
            ...
            <h2
              className={`text-xl font-light mb-1 ${isDark ? "text-white" : "text-slate-800"}`}
            >
              Digite seu PIN
            </h2>
            <p
...
function LoadingScreen({ isDark = true }: { isDark?: boolean }) {
  return (
    <div
      className={`flex h-screen items-center justify-center ${isDark ? "bg-slate-950" : "bg-amber-50"}`}
    >
